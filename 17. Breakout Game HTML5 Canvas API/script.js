...
// Create brick props
const brickInfo = { w: 48, h: 20, padding: 10, offsetX: 45, offsetY: 60, visible: true }
...
function moveBall() {
  ...
  if (ball.x + ball.size > canvas.width ||
    ...
    ball.dx *= -1; /* reverse direction and go the other way */
  }
  ...
  if (ball.y + ball.size > canvas.height ||
    ...
    ball.dy *= -1; /* reverse direction and go the other way */
  }
...
function update() {
  ...
  requestAnimationFrame(update); /* call itself */
}
